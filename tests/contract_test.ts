...
async function executeTest() {
    const keyBytes = Bytes.fromHex('2b14bf840ade828e8548a993307050e4d96cb2a580fdfd63d8e40c5cee1e3deb');
    ...
    const contract = rweb3.createContract(jsonInterface.abi, 'fd4d3b0f16c74cd236ad8761309d51ef92ca880b');
    const result = await contract.execute(importUser, 'transfer', ['280057599c3975537bb8ad42343078d879384436', BigInt('100')]);
    console.log(result);
}
...
async function queryTest() {
    ...
    const jsonInterface = JSON.parse(fs.readFileSync('./erc20_test_contract.json', 'utf-8'));
    const contract = rweb3.createContract(jsonInterface.abi, 'fd4d3b0f16c74cd236ad8761309d51ef92ca880b');
    const result = await contract.query(importUser, 'balanceOf', ['280057599c3975537bb8ad42343078d879384436']);
