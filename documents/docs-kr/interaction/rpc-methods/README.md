...
## 개요
이 문서는 `RIGO` 블록체인의 다양한 RPC 요청들을 처리하는 함수를 설명합니다. `RIGO` 블록체인에서는 데이터를 조회하기 위한 다양한 RPC 메소드들을 제공하고 있습니다. 제공하는 RPC 메소드들을 요청하는 방법을 예시를 통해 확인할 수 있습니다.

## RPC 요청 함수

### `health`
`RIGO` 노드의 네트워크 연결 상태를 확인하는 health 메소드를 호출합니다.
- 요청
```typescript
...
### `status`
`RIGO` 네트워크의 상태를 확인하는 status 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `netInfo`
`RIGO` 네트워크에 대한 정보를 확인하는 netInfo 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `genesis`
`RIGO` 블록체인의 제네시스 정보를 조회할 수 있는 genesis 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `dumpConsensusState`
`RIGO` 블록체인의 현재 합의 상태를 조회할 수 있는 dump_consensus_state 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `consensusState`
`RIGO` 블록체인의 합의 상태 정보를 조회할 수 있는 consensus_state 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `tx`
`RIGO` 블록체인에서 트랜잭션 해시 값을 입력해서 결과 값을 조회할 수 있는 tx 메소드를 호출합니다.
-요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `abciInfo`
`RIGO` 블록체인 노드 정보를 조회할 수 있는 abci_info 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3 } from '@rigochain/rweb3';
...
### `checkTx`
`RIGO` 블록체인에 제출하기 전 트랜잭션의 상태를 확인할 수 있는 check_tx 메소드를 호출합니다.
- 요청
```typescript
...
### `broadcastTxAsync`
트랜잭션을 `RIGO` 블록체인 네트워크에 비동기적으로 제출할 수 있는 broadcast_tx_async 메소드를 호출합니다..
- 요청
```typescript
import { RWeb3, TrxProtoBuilder, TrxProto, AccountResponse } from '@rigochain/rweb3';
import { RWeb3Account } from '@rigochain/rweb3-rigo-accounts';
...
### `broadcastTxSync`
트랜잭션을 `RIGO` 블록체인 네트워크에 비동기적으로 제출할 수 있는 broadcast_tx_sync 메소드를 호출합니다.
- 요청
```typescript
import { RWeb3, TrxProtoBuilder, TrxProto, AccountResponse } from '@rigochain/rweb3';
import { RWeb3Account } from '@rigochain/rweb3-rigo-accounts';
